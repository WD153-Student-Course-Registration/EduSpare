...
<head>
    ...
    <meta name="description" content="Login to the Student Registration System.">
...
<body>
    ...
    <nav>
        ...
        <div class="nav-links">
            <a href="/">Home</a>
            <a href="/register" class="btn btn-primary" style="padding: 0.5rem 1rem;">Register</a>
        </div>
    </nav>
    ...
    <main class="container">
        <div class="form-container glass-panel">
            ...
            <form action="/LoginEndpoint" method="POST" id="loginForm">
